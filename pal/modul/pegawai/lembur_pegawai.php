...
switch($_GET[act]){
  ...
  echo "<tr class='gradeX'>
	...
	<td>
	<a href='?module=pegawai&act=transfergaji&id=$dt[nip]' class='btn btn_users'><span>Lembur Pegawai</span></a></td>
  </tr>";
  $no++;
  }
echo "  
    ...
    <span class='field'><input class='input' name='gaji_pokok' type='text'>
	</p>
	...
	<p>
    <label>Gaji Pokok</label>
    <span class='field'><input class='input' name='gaji_pokok' type='text' value='Rp. $gaji_pokok'  readonly>
	</p>
	...
	<tr>
	<td>Gaji Pokok</td><td>:</td><td>Rp. $gaji_pokok</td>
	</tr>
	...
	echo "<div class='contenttitle2'><h3>Data Slip Gaji $t[nama]</h3></div>
	<div class='detailpegawai' >
	<table class='tabelform tabpad'>";
     echo "<tr>
                    <td>Nip</td>
